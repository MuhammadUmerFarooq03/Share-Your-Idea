...
<html>
    <head>
        ...
        <title><?php echo $page_title; ?> - Admin Panel - LGU Robotics Society</title>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo ADMIN_BASE_URL; ?>" class="logo">
                    ...
                    <span class="logo-lg"><b>LGU Robotics Society</b></span>
                </a>
                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div class="navbar-custom-menu">
                        ...
                        <a href="<?php echo ADMIN_BASE_URL; ?>logout.php" class="btn btn-default btn-flat" style="margin: 8px;">Logout</a>
                    </div>
                </nav>
            </header>