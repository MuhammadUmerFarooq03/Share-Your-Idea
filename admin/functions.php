...
function getAllUserList() {
    ...
    while ($row = $res->fetch_assoc()) {
        ...
        $user_list .= "<td>" . $i++ . "</td>"
                ...
                . "<td>" . $row['email'] . "</td>"
                . "<td>" . $row['datetime'] . "</td>"
                . "<td><a class='btn btn-sm btn-info edit' data='" . $row['id'] . "'><i class='fa  fa-pencil'></i> View/Edit</a> <a class='btn btn-sm btn-danger delete' data='" . $row['id'] . "'><i class='fa fa-trash'></i> Delete</a> <a class='btn btn-sm btn-primary password' data='" . $row['id'] . "'> Change Password</a></td>";
        $user_list .= "</tr>";
    }
